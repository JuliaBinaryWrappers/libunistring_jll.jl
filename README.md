# `libunistring_jll.jl` (v1.4.1+0)

[![deps](https://juliahub.com/docs/libunistring_jll/deps.svg)](https://juliahub.com/ui/Packages/General/libunistring_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/9a148f885e660cb5cdeb3f5f672cc68f876fb6b2/L/libunistring/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `libunistring_jll.jl` have been built from these sources:

* compressed archive: https://ftpmirror.gnu.org/gnu/libunistring/libunistring-1.4.1.tar.xz (SHA256 checksum: `67d88430892527861903788868c77802a217b0959990f7449f2976126a307763`)

## Platforms

`libunistring_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `libunistring_jll.jl`:
